...
export default defineComponent({
  setup() {
    ...
    async function update() {
      const n = await visited.setVal(true)
    }
...
<template>
  <div>
    <div class="flex h-14 md:invisible md:h-0 justify-between">
      <div class="pl-6 pt-6 w-12 h-12">
        MENU
      </div>
      <div class="mt-6">
        LOGO
